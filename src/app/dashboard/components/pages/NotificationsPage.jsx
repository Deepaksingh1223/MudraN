    ...
    <div className="dash-pad">
      <div className="ph">
        <div>
          ...
          <div className="dash-h1">Notifications</div>
        </div>
        <button className="btn dash-btn-muted dashboard-btn dash-bsm" onClick={() => onToast("All notifications marked as read")}>Mark all read</button>
      </div>
      ...
      <div className="dash-card" style={{ padding: 0 }}>
        {[ 
          ...
          <div key={t} className="dash-ni2">
            <div className="dash-nav2">
